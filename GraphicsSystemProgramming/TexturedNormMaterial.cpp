...
TexturedNormMaterial::TexturedNormMaterial()
{
...
void TexturedNormMaterial::Init(ID3D11Device* p_pDevice, ID3D11DeviceContext* p_pDevCon)
{
	Material::Init(p_pDevice, p_pDevCon);

	ID3D10Blob* _pVertexShader = LoadShaders("TexturedNormShader.hlsl", "VShader", "TexturedNormShader.hlsl", "PShader");
	...
	m_pDevice->CreateInputLayout(_IED, 4, _pVertexShader->GetBufferPointer(),
...
void TexturedNormMaterial::Bind()
{
